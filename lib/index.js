...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InfiniteScroll = (function (_React$Component) {
	  ...
	  _createClass(InfiniteScroll, [{
	    ...
	    value: function render() {
	      ...
	      var styleProp = _props.style;
	      var hasChildrenProp = _props.hasChildren;
	      var children = _props.children;
	      var hasMore = _props.hasMore;
	      var loader = _props.loader;
	      var endMessage = _props.endMessage;
	      var classNameProp = _props.className;
	      var pullDownToRefresh = _props.pullDownToRefresh;
	      var pullDownToRefreshContent = _props.pullDownToRefreshContent;
	      var releaseToRefreshContent = _props.releaseToRefreshContent;
	      var _state = this.state;
	      var showLoader = _state.showLoader;
	      var pullToRefreshThresholdBreached = _state.pullToRefreshThresholdBreached;
	      ...
	      var hasChildren = hasChildrenProp || children && children.length;

	      var content = React.createElement(
	        'div',
	        { className: (0, _classnames2['default'])('infinite-scroll-component', classNameProp),
	          ref: function (infScroll) {
	            return _this3._infScroll = infScroll;
	          }, style: style },
	        pullDownToRefresh && React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            !pullToRefreshThresholdBreached && pullDownToRefreshContent,
	            pullToRefreshThresholdBreached && releaseToRefreshContent
	          )
	        ),
	        children,
	      ...
	      return pullDownToRefresh && height ? React.createElement(
	        'div',
	        { style: { overflow: 'auto' } },
	        content
	      ) : content;
	...
	InfiniteScroll.defaultProps = {
	  pullDownToRefreshContent: React.createElement(
	    'h3',
	    null,
	    'Pull down to refresh'
	  ),
	  releaseToRefreshContent: React.createElement(
	    'h3',
	    null,
	    'Release to refresh'
	  ),
